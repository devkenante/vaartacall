...
object KenanteWsSendMessages {
    ...
    fun attachJanusPlugin(session_id: BigInteger, isPublisher: Boolean, userId: String) {
    ...
    fun joinRoom(
        ...
        if (userRole == UserRoles.subscriber) {
            ...
            json.put("feed", publisher_id)
        } else {
            json.put("id", publisher_id)
        }
